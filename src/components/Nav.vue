...
<div class="container mx-auto flex items-center justify-between">
    ...
    <nav>
        <ul class="flex ">
            ...
            <button @click="loggingOut"><li class="py-8 px-4 hover:cursor-pointer hover:bg-pink-300 hover:text-red-900 text-xl">Logout</li></button>
            </div>
        </ul>
    </nav>
</div>
